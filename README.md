...
> **Private 開発正本** — 自社アプリ（AI-Dash 等）は Public ミラー [`SLT-Design-System-public`](https://github.com/SoundLabbitTechnology/SLT-Design-System-public) を参照します。運用: [docs/DUAL_REPO.md](./docs/DUAL_REPO.md) / 導入: [docs/adoption/public-consumer-install.md](./docs/adoption/public-consumer-install.md)

## まず選ぶ

| 目的 | 入口 |
|------|------|
| プロダクトへ導入する（自社 consumer） | [public-consumer-install](./docs/adoption/public-consumer-install.md)（**Public tag**） |
| プロダクトへ導入する（本リポ開発者） | [5 分で導入](#5-分で導入) |
...
| リリースする | [RELEASING](./docs/RELEASING.md) / [DUAL_REPO](./docs/DUAL_REPO.md) |
...
UNLICENSED — Sound Labbit Technology 内部利用。
