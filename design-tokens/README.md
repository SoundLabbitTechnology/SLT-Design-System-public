...
Component Variants ↔ props: [figma-props-mapping.md](../docs/L2-components/figma-props-mapping.md)。coral 方針: [ADR-001](../docs/decisions/ADR-001-coral-brand-colors.md)。
