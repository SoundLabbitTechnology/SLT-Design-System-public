...
| Component | props、state、behavior | story、site page、DoD、G3、必要なら G4 |
...
完成条件は [L2 DoD](./L2-components/dod.md)、Storybook の書式は [Storybook 標準](./L2-components/storybook.md) を正とします。
