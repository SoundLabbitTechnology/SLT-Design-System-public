...
出典: [Emil Kowalski — Skills for Design Engineers](https://github.com/emilkowalski/skills)（MIT）。原本は [docs/reference/emilkowalski-skills/](../reference/emilkowalski-skills/README.md)。

SLT の UI・コンポーネント・消費者画面で **動きと触感** を決めるときの判断基準です。トークン名と duration の上限は SLT が優先。曲線・頻度・物理性の感覚は本ガイドと原本スキルに従います。
...
|--------------|----------|
| 実装・レビューの最短ルール | この文書 |
| 厳密なアニメーションレビュー | [review-animations](../reference/emilkowalski-skills/skills/review-animations/SKILL.md) |
| コードベース横断の改善計画 | [improve-animations](../reference/emilkowalski-skills/skills/improve-animations/SKILL.md) |
| 「動かす／動かさない」の提案だけ | [find-animation-opportunities](../reference/emilkowalski-skills/skills/find-animation-opportunities/SKILL.md) |
| 効果の名前を探す | [animation-vocabulary](../reference/emilkowalski-skills/skills/animation-vocabulary/SKILL.md) |
| ジェスチャ・スプリングの深掘り | [apple-design](../reference/emilkowalski-skills/skills/apple-design/SKILL.md) |
| 総合クラフト | [emil-design-eng](../reference/emilkowalski-skills/skills/emil-design-eng/SKILL.md) |
...
4. **UI は短く** — 操作フィードバックは `fast` / `base`。`slow` は待たせに使わない（[ADR-004](../decisions/ADR-004-laws-of-ux.md) Doherty）。
...
詳細値・曲線・デバッグ手順は原本の [STANDARDS.md](../reference/emilkowalski-skills/skills/review-animations/STANDARDS.md) を参照。SLT では曲線の「強さ」の参考にしつつ、公開変数は上表の `--motion-easing-*` を使う。

## 関連

- [余白・形状・モーション](./spacing-motion.md)
- [L5 品質](../L5-quality.md)
- [L2 DoD](../L2-components/dod.md)
