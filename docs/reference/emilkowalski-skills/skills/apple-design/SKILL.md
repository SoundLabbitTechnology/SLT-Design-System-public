...
> **Note:** This skill is an unofficial distillation of publicly discussed Apple design talks (chiefly WWDC). It is not an Apple product, endorsement, or official documentation.
