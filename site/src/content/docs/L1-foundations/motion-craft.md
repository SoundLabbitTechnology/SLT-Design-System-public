...
詳細値・曲線・デバッグ手順は `.cursor/skills/review-animations/STANDARDS.md` と upstream を参照。SLT では曲線の「強さ」の参考にしつつ、公開変数は上表の `--motion-easing-*` を使う。

## 関連

- [余白・形状・モーション](./spacing-motion.md)
- [L5 品質](../L5-quality.md)
- [Storybook 標準](../L2-components/storybook.md)
